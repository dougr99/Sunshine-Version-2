...
import android.content.ContentValues; //ContentUris in diff
import android.content.Context;
import android.content.Intent; // replaces concept of context
...
public class SunshineService extends IntentService {
 ...
 //   }
    public SunshineService(){
        super("Sunshine"); // why is this hardcoded
        Log.e(LOG_TAG,"enter constructor");
    }
    static public class AlarmReceiver extends BroadcastReceiver {
        private final String LOG_TAG = AlarmReceiver.class.getSimpleName();
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.e(LOG_TAG,"entered onReceive");
 ...
 //       String locationQuery = params[0];
        Log.e(LOG_TAG,"enter onHandleIntent");
...
//                    .appendQueryParameter(QUERY_PARAM, params[0])
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        Log.e(LOG_TAG,"enter getWeatherDataFromJson");
...
//                low = temperatureObject.getDouble(OWM_MIN);
            ...
            if ( cVVector.size() > 0 ) {
                ...
                // Service has its own context, so mContext replaced with
                // this.getContentResolver()
                // not sure exactly how getContentResolver works


                this.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
//                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
            }

            Log.d(LOG_TAG, "Sunshine Service Complete. " + inserted + " Inserted size of vector " + cVVector.size());
